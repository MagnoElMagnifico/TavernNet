...
from .utils import SITE, RANDOM_WORDS, REFRESH_COOKIE, INVALID_ID
...
def test_post_comments(login: LoginUser):
    pass
    # CREAR UN COMENTARIO
    # TODO: verificar que los IDs están en hexadecimal
    # VER COMENTARIOS DE UN POST

def test_post_likes(login: LoginUser):
    pass
    # DAR LIKE
    # TODO: verificar que los IDs están en hexadecimal
...
def test_post_delete(login: LoginUser):
    pass
    # BORRAR UN POST
...
def test_posts(login: LoginUser):
    ...
    test_post_search(login, jwt_with_char)
    test_post_comments(login)
    test_post_likes(login)
    test_post_delete(login)
